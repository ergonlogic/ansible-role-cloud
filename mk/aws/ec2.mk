...
aws-ec2-test-slow: features/files/roles/ergonlogic.cloud
	ansible-playbook features/files/hosts/aws/ec2/test2.yml -e 'confirm=y' -e 'op=ec2'
	ansible-playbook features/files/hosts/aws/ec2/test1.yml -e 'confirm=y' -e 'op=ec2'
	ansible-playbook features/files/hosts/aws/ec2/test2.yml -e 'confirm=y' -e 'op=ec2'
	rm features/files/roles/ergonlogic.cloud
...
aws-ec2-destroy: ansible aws-ec2-inventory-quiet
	AWS_EC2_STATE=absent ansible-playbook $(CLOUD_PLAYBOOK)

aws-ec2-destroy-force: ansible aws-ec2-inventory-quiet
	AWS_EC2_STATE=absent ansible-playbook $(CLOUD_PLAYBOOK) -e "confirm=y"
